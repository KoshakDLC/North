...
final class LuxFractureRenderer {
   ...
   private static final String ASSETS_WILD_SHADERS_HUD_LUX_FRACTURE_EDGE_FRAG = "assets/wild/shaders/hud/lux_fracture_edge.frag";
   private static final long TIMESTAMP = 3000000L;
   private static final float FLOAT_VALUE = 1.0F;
   private static final float FLOAT_VALUE_2 = 2.5F;
   ...
   private boolean check2(
      ...
      if (!this.flag2 && renderManager2 != null && client != null && client.getWindow() != null && !(h <= 1.0F) && !(i <= 1.0F) && !(k <= 0.001F)) {
         ...
         if (intValue > 1 && intValue2 > 1 && this.check3()) {
            ...
            float floatValue = Math.max(56.0F, j * 5.0F);
            ...
            label287: {
               ...
               try {
                  ...
                  if (this.intValue24 >= 0) {
                     GL20.glUniform1f(this.intValue24, 1.0F);
                  }

                  if (this.intValue25 >= 0) {
                     GL20.glUniform1f(this.intValue25, 2.5F);
                  }
                  ...
                  if (this.intValue21 >= 0) {
                     GL20.glUniform2f(
                        this.intValue21, this.intValue27 > 0 ? this.intValue27 : intValue, this.intValue28 > 0 ? this.intValue28 : intValue2
                     );
                  }
                  ...
                  System.err.println("[LuxFracture] surface draw disabled: " + exception.getMessage());
   ...
   private int compute(int i, int j) {
      ...
      if (this.intValue26 > 0 && this.intValue27 == i && this.intValue28 == j && longValue2 - this.timestamp < 3000000L) {
         return this.intValue26;
      } else {
         try {
            ...
            if (renderEngine == null) {
               ...
               if (renderEngineBounds != null && renderEngineBounds.colorTexture() > 0 && renderEngineBounds.width() > 0 && renderEngineBounds.height() > 0) {
                  this.intValue26 = renderEngineBounds.colorTexture();
                  this.intValue27 = renderEngineBounds.width();
                  this.intValue28 = renderEngineBounds.height();
   ...
   private boolean check3() {
      if (!this.flag) {
         ...
         try {
            this.glShaderProgram = GlShaderProgram.resolve("assets/wild/shaders/blur/blur_fullscreen.vert", "assets/wild/shaders/hud/lux_fracture_edge.frag");
            ...
            this.intValue24 = this.glShaderProgram.compute2("uSpectralBloomStrength");
            this.intValue25 = this.glShaderProgram.compute2("uRefractionDensityFade");
            ...
            System.err.println("[LuxFracture] surface shader failed to load (style will fall back): " + exception3.getMessage());
