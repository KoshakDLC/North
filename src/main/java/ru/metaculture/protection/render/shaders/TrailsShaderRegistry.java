...
public final class TrailsShaderRegistry {
   private static final int INT_VALUE = 2097152;
   private static final Identifier IDENTIFIER = Identifier.of("wild", "core/trails_glass");
   ...
   private static final RenderLayer RENDER_LAYER = RenderLayer.of(
      "wild/trails_glass", 2097152, false, true, RENDER_PIPELINE, MultiPhaseParameters.builder().build(false)
   );
   private static final RenderLayer RENDER_LAYER_2 = RenderLayer.of(
      "wild/trails_emissive", 2097152, false, true, RENDER_PIPELINE_2, MultiPhaseParameters.builder().build(false)
   );

   private TrailsShaderRegistry() {
   }
