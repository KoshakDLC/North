...
public final class GlacierVeilMenuShader implements AutoCloseable {
   private static final GlacierVeilMenuShader INSTANCE = new GlacierVeilMenuShader();
   private static final String ASSETS_WILD_SHADERS_MAINMENU_MENU_QUAD_VERT = "assets/wild/shaders/mainmenu/menu_quad.vert";
   private static final String ASSETS_WILD_SHADERS_MAINMENU_GLACIER_VEIL_FRAG = "assets/wild/shaders/mainmenu/glacier_veil.frag";
   ...
   public static GlacierVeilMenuShader getINSTANCE() {
      return INSTANCE;
   }
   ...
   public void invoke(int i, int j, float f, float g, ColorScheme colorScheme, float h) {
      if (i > 0 && j > 0) {
         ...
         try {
            ...
            int intValue = colorScheme == null ? -5706497 : colorScheme.getIntValue14();
            int intValue2 = colorScheme == null ? -12681729 : colorScheme.getIntValue15();
   ...
   private void invoke3() {
      ...
      if (this.fullscreenQuadResources == null) {
         this.fullscreenQuadResources = this.fullscreenQuad
            .resolve("glacier_veil_click_gui", "assets/wild/shaders/mainmenu/menu_quad.vert", "assets/wild/shaders/mainmenu/glacier_veil.frag");
      }
   }
