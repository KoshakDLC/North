...
public final class PorcelainDawnMenuShader implements AutoCloseable {
   private static final PorcelainDawnMenuShader INSTANCE = new PorcelainDawnMenuShader();
   private static final String ASSETS_WILD_SHADERS_MAINMENU_MENU_QUAD_VERT = "assets/wild/shaders/mainmenu/menu_quad.vert";
   private static final String ASSETS_WILD_SHADERS_MAINMENU_PORCELAIN_DAWN_FRAG = "assets/wild/shaders/mainmenu/porcelain_dawn.frag";
   ...
   public static PorcelainDawnMenuShader getINSTANCE() {
      return INSTANCE;
   }
   ...
   public void invoke(int i, int j, float f, float g, ColorScheme colorScheme, float h) {
      if (i > 0 && j > 0) {
         ...
         try {
            ...
            int intValue = colorScheme == null ? -9816 : colorScheme.getIntValue14();
            int intValue2 = colorScheme == null ? -19589 : colorScheme.getIntValue15();
            ...
            this.fullscreenQuadResources.invoke3("uAlpha", this.measure2(h) * 0.85F);
   ...
   private void invoke3() {
      ...
      if (this.fullscreenQuadResources == null) {
         this.fullscreenQuadResources = this.fullscreenQuad
            .resolve("porcelain_dawn_click_gui", "assets/wild/shaders/mainmenu/menu_quad.vert", "assets/wild/shaders/mainmenu/porcelain_dawn.frag");
      }
   }
