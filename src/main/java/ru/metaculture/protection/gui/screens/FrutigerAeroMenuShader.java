...
public final class FrutigerAeroMenuShader implements AutoCloseable {
   private static final FrutigerAeroMenuShader INSTANCE = new FrutigerAeroMenuShader();
   private static final String ASSETS_WILD_SHADERS_MAINMENU_MENU_QUAD_VERT = "assets/wild/shaders/mainmenu/menu_quad.vert";
   private static final String ASSETS_WILD_SHADERS_MAINMENU_FRUTIGER_AERO_FRAG = "assets/wild/shaders/mainmenu/frutiger_aero.frag";
   ...
   public static FrutigerAeroMenuShader getINSTANCE() {
      return INSTANCE;
   }
   ...
   public void invoke(int i, int j, float f, float g, ColorScheme colorScheme, float h) {
      if (i > 0 && j > 0) {
         ...
         try {
            ...
            int intValue = colorScheme == null ? -8657678 : colorScheme.getIntValue14();
            int intValue2 = colorScheme == null ? -13121888 : colorScheme.getIntValue15();
   ...
   private void invoke3() {
      ...
      if (this.fullscreenQuadResources == null) {
         this.fullscreenQuadResources = this.fullscreenQuad
            .resolve("frutiger_aero_click_gui", "assets/wild/shaders/mainmenu/menu_quad.vert", "assets/wild/shaders/mainmenu/frutiger_aero.frag");
      }
   }
