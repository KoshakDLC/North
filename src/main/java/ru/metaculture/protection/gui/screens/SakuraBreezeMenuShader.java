...
public final class SakuraBreezeMenuShader implements AutoCloseable {
   private static final SakuraBreezeMenuShader INSTANCE = new SakuraBreezeMenuShader();
   private static final String ASSETS_WILD_SHADERS_MAINMENU_MENU_QUAD_VERT = "assets/wild/shaders/mainmenu/menu_quad.vert";
   private static final String ASSETS_WILD_SHADERS_MAINMENU_SAKURA_BREEZE_FRAG = "assets/wild/shaders/mainmenu/sakura_breeze.frag";
   ...
   public static SakuraBreezeMenuShader getINSTANCE() {
      return INSTANCE;
   }
   ...
   public void invoke(int i, int j, float f, float g, ColorScheme colorScheme, float h) {
      if (i > 0 && j > 0) {
         ...
         try {
            ...
            int intValue = colorScheme == null ? -18491 : colorScheme.getIntValue14();
            int intValue2 = colorScheme == null ? -16181 : colorScheme.getIntValue15();
   ...
   private void invoke3() {
      ...
      if (this.fullscreenQuadResources == null) {
         this.fullscreenQuadResources = this.fullscreenQuad
            .resolve("sakura_breeze_click_gui", "assets/wild/shaders/mainmenu/menu_quad.vert", "assets/wild/shaders/mainmenu/sakura_breeze.frag");
      }
   }
