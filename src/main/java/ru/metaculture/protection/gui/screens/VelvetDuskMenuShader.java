...
public final class VelvetDuskMenuShader implements AutoCloseable {
   private static final VelvetDuskMenuShader INSTANCE = new VelvetDuskMenuShader();
   private static final String ASSETS_WILD_SHADERS_MAINMENU_MENU_QUAD_VERT = "assets/wild/shaders/mainmenu/menu_quad.vert";
   private static final String ASSETS_WILD_SHADERS_MAINMENU_VELVET_DUSK_FRAG = "assets/wild/shaders/mainmenu/velvet_dusk.frag";
   ...
   public static VelvetDuskMenuShader getINSTANCE() {
      return INSTANCE;
   }
   ...
   public void invoke(int i, int j, float f, float g, ColorScheme colorScheme, float h) {
      if (i > 0 && j > 0) {
         ...
         try {
            ...
            int intValue = colorScheme == null ? -6656769 : colorScheme.getIntValue14();
            int intValue2 = colorScheme == null ? -10802531 : colorScheme.getIntValue15();
   ...
   private void invoke3() {
      ...
      if (this.fullscreenQuadResources == null) {
         this.fullscreenQuadResources = this.fullscreenQuad
            .resolve("velvet_dusk_click_gui", "assets/wild/shaders/mainmenu/menu_quad.vert", "assets/wild/shaders/mainmenu/velvet_dusk.frag");
      }
   }
