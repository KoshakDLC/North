...
public final class VernalSolsticeMenuShader implements AutoCloseable {
   private static final VernalSolsticeMenuShader INSTANCE = new VernalSolsticeMenuShader();
   private static final String ASSETS_WILD_SHADERS_MAINMENU_MENU_QUAD_VERT = "assets/wild/shaders/mainmenu/menu_quad.vert";
   private static final String ASSETS_WILD_SHADERS_MAINMENU_VERNAL_SOLSTICE_FRAG = "assets/wild/shaders/mainmenu/vernal_solstice.frag";
   ...
   public static VernalSolsticeMenuShader getINSTANCE() {
      return INSTANCE;
   }
   ...
   public void invoke(int i, int j, float f, float g, ColorScheme colorScheme, float h) {
      if (i > 0 && j > 0) {
         ...
         try {
            ...
            int intValue = colorScheme == null ? -13447886 : colorScheme.getIntValue14();
            int intValue2 = colorScheme == null ? -10496 : colorScheme.getIntValue15();
            ...
            this.fullscreenQuadResources.invoke3("uActivity", 1.0F);
            this.fullscreenQuadResources.invoke3("uAlpha", this.measure2(h) * 0.76F);
            this.fullscreenQuadResources.invoke3("uLightMode", 1.0F);

            for (int intValue3 = 0; intValue3 < 14; intValue3++) {
               this.fullscreenQuadResources.invoke6("uTrail[" + intValue3 + "]", 0.0F, 0.0F, 100.0F, 0.0F);
            }
   ...
   private void invoke3() {
      ...
      if (this.fullscreenQuadResources == null) {
         this.fullscreenQuadResources = this.fullscreenQuad
            .resolve("vernal_solstice_click_gui", "assets/wild/shaders/mainmenu/menu_quad.vert", "assets/wild/shaders/mainmenu/vernal_solstice.frag");
      }
   }
