...
public final class MidnightAzureMenuShader implements AutoCloseable {
   private static final MidnightAzureMenuShader INSTANCE = new MidnightAzureMenuShader();
   private static final String ASSETS_WILD_SHADERS_MAINMENU_MENU_QUAD_VERT = "assets/wild/shaders/mainmenu/menu_quad.vert";
   private static final String ASSETS_WILD_SHADERS_MAINMENU_MIDNIGHT_AZURE_FRAG = "assets/wild/shaders/mainmenu/midnight_azure.frag";
   ...
   public static MidnightAzureMenuShader getINSTANCE() {
      return INSTANCE;
   }
   ...
   public void invoke(int i, int j, float f, float g, ColorScheme colorScheme, float h) {
      if (i > 0 && j > 0) {
         ...
         try {
            ...
            int intValue = colorScheme == null ? -16715521 : colorScheme.getIntValue14();
            int intValue2 = colorScheme == null ? -16759553 : colorScheme.getIntValue15();
            ...
            this.fullscreenQuadResources.invoke3("uAlpha", this.measure2(h));
            this.fullscreenQuadResources.invoke3("uLightMode", 0.0F);
   ...
   private void invoke3() {
      ...
      if (this.fullscreenQuadResources == null) {
         this.fullscreenQuadResources = this.fullscreenQuad
            .resolve("midnight_azure_click_gui", "assets/wild/shaders/mainmenu/menu_quad.vert", "assets/wild/shaders/mainmenu/midnight_azure.frag");
      }
   }
