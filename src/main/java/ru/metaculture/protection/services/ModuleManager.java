...
public class ModuleManager {
   ...
   public void registerModules() {
      Class<?>[] classValues = new Class<?>[]{
         ...
         AutoTool.class, AutoTotem.class, AutoVillageTrade.class, AutoWarden.class, AutoWood.class, BaseFinder.class, Blink.class,
         ...
         PotionCombiner.class, Predictions.class, ProjectileHelper.class, ProtectInfo.class, PvPSafe.class, Removals.class, RotationLab.class,
