...
public enum Theme {
   WILD("North", new Color(16719647), new Color(1182219), new Color(1708050), new Color(3021599), new Color(16777215), new Color(10915474)),
   ...
   public final DirectionalAnimation directionalAnimation = new EaseInOutQuadAnimation(300, 1.0);

   private Theme(String string2, Color color, Color color2, Color color3, Color color4, Color color5, Color color6) {
      this.text = string2;
      this.color = color;
      this.color2 = color2;
      this.color3 = color3;
   ...
   public void invoke(Color color, Color color2, Color color3, Color color4, Color color5, Color color6) {
      if (this == CUSTOM) {
         this.color = color;
         this.color2 = color2;
         this.color3 = color3;
